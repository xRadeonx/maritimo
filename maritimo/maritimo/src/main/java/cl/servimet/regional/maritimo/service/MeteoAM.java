...
public class MeteoAM {
    ...
    @ExcelCellName("indiceRadiacionUV")
    ...
    public MeteoAM(Long idPronostico, Long idCentro, Long idBahia, String dia, Integer numeral, String mes, String inicio, String fin, String zonaHoraria, String temperaturaMinima, String temperaturaMaxima, String indiceRadiacionUV, String situacionSinoptica, String coberturaNubosa, String visibilidad, String fenomenoAtmosferico, String direccionViento1, String velocidad1, String direccionViento2, String velocidad2, String alturaOlas, String descripcion, String estadoMarBahia) {
        ...
        this.indiceRadiacionUV = indiceRadiacionUV;
    ...
    public String getIndiceRadiacionUV() {
        return indiceRadiacionUV;
    }

    public void setIndiceRadiacionUV(String indiceRadiacionUV) {
        this.indiceRadiacionUV = indiceRadiacionUV;
    }
    ...
    public String toString() {
        return "MeteoAM{" +
                ...
                ", indiceRadiacionUV='" + indiceRadiacionUV + '\'' +
