...
public class CanalesAustrales {
    ...
    public CanalesAustrales(Long id, String titulo, String inicio, String fin, String zona, String nubosidad, String visibilidad, String viento, String estado_mar, String situacion_sinoptica, String apreciacion, String valida_desde, String valida_hasta, String zona_horaria, String situacion, String cobertura_nubosa, String visibilidad_apreciacion, String viento_apreciacion) {
        this.id = id;
        this.titulo = titulo;
        this.inicio = inicio;
        this.fin = fin;
